...
var reventitiesDefault = (function () {
    var result = {};
    for(var key in entitiesDefault) { if(entitiesDefault.hasOwnProperty(key)) {
        result[entitiesDefault[key]] = key;
    } }
    return result;
})();
...
// 'reventities' is optional. Defaults to entitiesDefault
function xmlEscape(str, acc, reventities) {
    //determine which table is to be used for encoding
    if (!reventities) {
        reventities = reventitiesDefault;
    }
